...
보편적 기본소득(UBI) 논의가 다시 불붙고 있다. 영국 정부는 AI로 인한 실직자를 위한 UBI 도입을 적극 검토하겠다고 발표했다. 하지만 재분배만으로는 부족하다. 연산 자원의 공유, AI 인프라에 대한 공적 투자, 새로운 형태의 디지털 공유지(digital commons)가 필요할 수 있다. 아니면 우리가 아직 상상조차 못한 무언가일 수도 있다.

커피는 이미 끓고 있다. 남은 질문은 하나, 이 커피가 어떤 혁명을 끓여낼 것인가?