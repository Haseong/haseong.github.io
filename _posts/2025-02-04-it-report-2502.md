...
categories: Report
tags: IT산업 트렌드 분석리포트
excerpt: "2025년 1월 IT 업계는 저비용 AI 모델 개발과 실시간 데이터 활용이 주요 트렌드로 부상했습니다. DeepSeek V3와 UC버클리의 450달러 미만 오픈소스 모델이 AI 연구의 민주화를 촉진하고 있습니다. 구글의 TITANs는 트랜스포머 2.0으로 불리며 장기 기억 기능을 통해 AI의 인지 능력을 한 단계 높였습니다. 한국은 AI 경쟁력 강화를 위해 100조 원 규모의 대규모 투자가 필요한 상황입니다."
